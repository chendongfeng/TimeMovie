...
- (void)viewDidLoad {
    ...
    // 创建collectionView
    imageCollectionView = [[UICollectionView alloc] initWithFrame:self.view.bounds collectionViewLayout:layout];
...
#pragma mark - 文件读取
-(void)loadData{
    NSArray *array = [MovieJSON1 readJSONFile:@"image_list副本"];
